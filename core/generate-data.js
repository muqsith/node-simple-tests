...
let lines = fs.readFileSync('../data/all-completed-jobs.txt').toString().split('\n');
...
for (let i = 0, timestamp = start_date.getTime(), line_index = 0; 
        i < seconds; i += 1, line_index += 1, timestamp += (1000)) {
