...
const tables = {
    'v6': [{
        ...
        values: ['testdata@test.tes', 'testpaypal@test.tes', '{"street": "test street","city": "test","zip": "12345","countryId": "AE","displayCountry": "United Arab Emirates"}']
    }, {
        name: 'orders',
        fields: ['email', 'key', 'paymentmethod'],
        values: ['testdata@test.tes', 'testkey', '{"id": "123456","shopid": "123456","enabled": true,"archived": false,"paymenttype": "testpaypal","paymentdetails": {"email": "test@webshop.test"}}']
        ...
        name: 'stripe_connect',
        fields: ['access_token', 'refresh_token', 'stripe_user_id', 'stripe_publishable_key'],
        values: ['access-token-testid', 'refresh-token-testid', 'stripe-user-id-testid', 'stripe-publishable-key-testid']
    }]
};
