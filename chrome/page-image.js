...
function screenshot(href, filepath) {
  let browser = null,
    page = null;
  puppeteer
    .launch({ executablePath: "/usr/bin/google-chrome-stable" })
    .then((_browser) => {
...
screenshot(
  "http://demo.xpeedstudio.com/html/fundpress/",
  "/home/muqsith/Pictures/fundpress.png",
);
screenshot(
  "http://wptheme.co.in/restaurent_html/",
  "/home/muqsith/Pictures/food.png",
);
